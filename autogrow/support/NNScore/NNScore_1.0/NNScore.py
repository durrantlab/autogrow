...
class Complex:
    ...
    def __init__ (self, ligand, receptor): # ligand_name, receptor_name):
        ...
        #print "Getting data from ligand,receptor = " + ligand_name +","+receptor_name
        ...
        #    #self.nn_input = p(picklename)
        #    pk_input = open(picklename,'r')
        #    self.nn_input = pickle.load(pk_input)
        #    pk_input.close()
        #    print "   Loaded from the pickle file " + picklename
        #    #print "DUDE", self.nn_input
        ...
        for ligand_index in ligand.AllAtoms:
            ...
            if not self.lig_types.has_key(lig_type):
            ...
            for receptor_index in receptor.AllAtoms:
                ...
                if dist < 4.0:
                    ...
                    if key in charge_type_combos:
                        ...
                        #print "CHARGE KEY: ",key, ligand_name, receptor_name
                    else:
                    ...
                    if dist < 2.0: # so it's a close contact
                        if key in proximity_2_type_combos:
                            ...
                            #print "DIST<2.0 KEY: ", key, ligand_name, receptor_name
                        else:
                        ...
                        if key in proximity_4_type_combos:
                            ...
                            #print "DIST<4.0 KEY: ", key, ligand_name, receptor_name
                        else:
        ...
        #print "ENTROPY: ",ligand_name,entropy_count
...
if ligand_name != "": # so a single pdbqt ligand was provided
    ...
    # now, print out PBD files in temp directory
    if not os.path.exists(sys.path[0] + "/tmp"):
        os.mkdir(sys.path[0] + "/tmp")
        print "Created directory " + sys.path[0] + "/tmp/"
    ...
    for pdb in pdbs:
        ...
        filename = sys.path[0] + '/tmp/' + name+"."+str(id) + ".pdb"
